...
${OBJECTDIR}/coordinator.o: coordinator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coordinator.o coordinator.cpp
...
${TESTDIR}/tests/socketservertest.o: tests/socketservertest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/socketservertest.o tests/socketservertest.cpp


${TESTDIR}/tests/mainfunctiontest.o: tests/mainfunctiontest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mainfunctiontest.o tests/mainfunctiontest.cpp
...
${OBJECTDIR}/coordinator_nomain.o: ${OBJECTDIR}/coordinator.o coordinator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coordinator_nomain.o coordinator.cpp;\
	else  \
